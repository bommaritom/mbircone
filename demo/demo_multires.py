...
low_res_recon = mbircone.multires.half_res_recon(sino, angles, dist_source_detector, magnification,
...
plot_image(low_res_recon[display_slice_recon], title=f'qGGMRF low res recon, axial slice {display_slice_recon}',
           filename=os.path.join(save_path, 'low_res_recon_axial.png'), vmin=vmin, vmax=vmax)
plot_image(low_res_recon[:,display_x_recon,:], title=f'qGGMRF low res recon, coronal slice {display_x_recon}',
